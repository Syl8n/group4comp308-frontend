...
function PredictHeartDisease() {
  ...
  const setMaximumHeartRateAchieved = (input) => {
    setPatientInfo({
      ...patientInfo,
      maximumHeartRateAchieved: parseInt(input),
    });
  };
        ...
        <div className="card shadow p-3 mt-5">
          ...
          <Form onSubmit={(e) => formSubmit(e)}>
            ...
            <FloatingLabel
              ...
              className="mb-3"
              controlId="restingBloodPressure"
            >
              <Form.Control
                type="number"
            ...
            <FloatingLabel
              ...
              className="mb-3"
              controlId="restingECG"
            >
              <Form.Select
                aria-label="Resting ECG Results"
                onChange={(e) =>
                  setRestingElectrocardiographicResults(e.target.value)
                }
              >
            ...
            <FloatingLabel
              ...
              className="mb-3"
              controlId="exerciseInducedAngina"
            >
              <Form.Select
            ...
            <FloatingLabel
              ...
              className="mb-3"
              controlId="numberMajorVessels"
            >
              <Form.Select
                aria-label="Number of Major Vessels"
                onChange={(e) => setNumberMajorVessels(e.target.value)}
              >
                <option value="">Choose...</option>
            ...
            <div className="d-flex justify-content-center mt-2">
              ...
              <div
                ...
                style={{ marginLeft: "10px", margin: "20px 0" }}
              >
                <Button
                  variant="secondary"
