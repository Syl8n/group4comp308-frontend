...
import { Navbar, Form, Button, FloatingLabel } from "react-bootstrap";
...
const MotivationalTip = () => {
  ...
  const [addMotivationalTip, { addLoading, addError }] = useMutation(
  ...
  if (addError)
    return <p>Error sending motivational tip: {addError.message}</p>;
